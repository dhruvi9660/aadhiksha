...
$sql =  "INSERT INTO `organisation` (`org_username`,`org_password`,`org_email`,`org_name`,`activationcode`,`status`)
...
$ms="Dear $name,<br>please click the following link to activate your account <br> <a href='http://localhost/aadhiksha/email_ver.php?code=$activationcode'>click here</a>";
